...
const PostCard = ({ post, currentUserId, onPostDeleted, onPostUpdated }) => {
    ...
    return (
        <div className="card mb-3 Full">
            <div className="card-body">
                <div className="d-flex align-items-center mb-2">
                    <img
                        src={
                            post.avatar
                                ? `http://localhost:5000/uploads/img/${post.avatar}`
                                : "/images.png"
                        }
                        alt={post.username}
                ...
                {editing ? (
                    ...
                    <>
                        <p className="card-text">{post.texts}</p>
                        {renderMedia()}

                        <div className="d-flex align-items-center mb-2">
                            <button
                                className={`btn btn-sm me-2 ${userVote === "up" ? "btn-success" : "btn-outline-success"
                                    }`}
                                onClick={() => votePost("up")}
                            >
                                ▲ {votes.upvotes}
                            ...
                            <button
                                className={`btn btn-sm me-2 ${userVote === "down" ? "btn-danger" : "btn-outline-danger"
                                    }`}
